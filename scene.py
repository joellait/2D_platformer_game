...
class Scene(QGraphicsScene):
    ...
    def set_up_game(self):
        ...
        if self.start_screen:
            ...
            self.start.create_background("0_lvl1_background.jpg")
            self.set_start_photo("0_startscreen.png", 100, 50)
            ...
            self.level_1.create_background("0_lvl1_background.jpg")
            ...
            if self.first_game:
                self.set_start_photo("0_lvl1.png")
            else:
                self.set_start_photo("0_gameover.png")
            #creates level 1 if it's not finished
      
        elif not self.level_2_finished:
            self.current_level_finished = False 
            self.level_2 = Level(self, 2, 3)
            self.level_2.create_background("0_lvl2_background.png")
            ...
            self.set_start_photo("0_lvl3.png")
            #creates level 3 after level 2 is finished
            
        else:
            self.game_completed = Level(self, 4, 1)
            self.game_completed.create_background("0_lvl3_background.jpg")
            self.set_start_photo("0_game_completed.png", 100,50)
